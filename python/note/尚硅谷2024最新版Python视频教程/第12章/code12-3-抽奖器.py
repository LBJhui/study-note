...
class MyFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        # 创建静态文本
        self.staticText = wx.StaticText(self.pl, label=random.choice(self.NameList), pos=(0, 50), size=(200, 200),
                                        style=wx.TE_CENTRE)
        # 创建字体
        # 字体大小，字体包，字体风格，加粗
        ...
        # 创建按钮
        self.btn1 = wx.Button(self.pl, label='开始抽奖', pos=(100, 300))
        self.btn2 = wx.Button(self.pl, label='结束抽奖', pos=(200, 300))
